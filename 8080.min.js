...
var t,h,b,o,q;var k=function(){this.b=0;this.c=0;this.d=0;this.e=0;this.f=0;this.h=0;this.l=0;this.a=0;this.pc=0;this.inte=0;this.sp=61440;this.cycles=0;
this.ram=[];};k.prototype.af=function(){return this.a<<8|this.f;};k.prototype.AF=function(u){this.a=u>>8&255;this.f=u&255;};k.prototype.bc=function(){return((this.b&255)<<8)|(this.c&255);
...
break;default:this.cycles+=4;break;}this.f&=215;this.f|=2;};var g,l=false;var p=function(){g.pc=0;g.sp=0;g.a=g.b=g.c=g.d=g.e=g.h=g.l=0;g.f=2;g.inte=0;g.cycles=0;
};var i=function(u){console.log(toHex4(u.pc));};r.trace=function(u){l=u;};r.steps=function(u){T=0;while(u>0){u-=g.step();if(l){i(g);}}};r.T=function(){return g.cycles;
};r.reset=p;r.init=function(v,y,u,w,x){t=v;h=y;q=u;b=w;o=x;g=new k();p();};r.status=function(){return{pc:g.pc,sp:g.sp,a:g.a,b:g.b,c:g.c,d:g.d,e:g.e,f:g.f,h:g.h,l:g.l};
};r.interrupt=function(u){if(g.inte){g.push(g.pc);g.pc=u||56;}};r.set=function(u,v){u=u.toUpperCase();switch(u){case"PC":g.pc=v;return;case"A":g.a=v;return;
