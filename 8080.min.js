...
};r.interrupt=function(u){if(g.f&j){g.push(g.pc);g.pc=u||56;}};r.set=function(u,v){switch(u){case"PC":g.pc=v;return;case"A":g.a=v;return;case"B":g.b=v;
return;case"C":g.c=v;return;case"D":g.d=v;return;case"E":g.e=v;return;case"H":g.h=v;return;case"L":g.l=v;return;case"F":g.f=v;return;case"SP":g.sp=v;return;
}};r.flagsToString=function(){var w="",v="SZ0A0P1C";for(var u=0;u<8;u++){var x=g.f&(128>>u);if(x===0){w+=v[u].toLowerCase();}else{w+=v[u];}}return w;};
