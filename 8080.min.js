...
};k.prototype.step=function(){var v=h(this.pc++);var u=this.cycles;this.execute(v);this.pc&=65535;return this.cycles-u;};k.prototype.writePort=function(w,u){if(b){b(w,u);
}};k.prototype.readPort=function(u){if(o){return o(u);}return 255;};k.prototype.getByte=function(u){return h(u);};k.prototype.getWord=function(w){var u=h(w);
var v=h(w+1);return v<<8|u;};k.prototype.nextByte=function(){var v=this.pc;var u=h(v);this.pc=(v+1)&65535;return u;};k.prototype.nextWord=function(){var v=this.pc;
var u=h(v);var w=h(v+1);this.pc=(v+2)&65535;return w<<8|u;};k.prototype.writeByte=function(x,w){var u=w&255;t(x,u);};k.prototype.writeWord=function(x,w){var u=w;
var v=w>>8;this.writeByte(x,u);this.writeByte(x+1,v);};k.prototype.calcFlags=function(y,w,z){var u=y&255;if(y>=256||y<0){this.f|=e;}else{this.f&=~e&255;
