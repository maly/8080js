...
function n(w,x){var v=[];for(var u=0;u<(x-w.length);++u){v.push("0");}v.push(w);return v.join("");}var e=1;var a=4;var s=16;var j=32;var m=64;var d=128;
var t,h,b,o,q;var k=function(){this.b=0;this.c=0;this.d=0;this.e=0;this.f=0;this.h=0;this.l=0;this.a=0;this.pc=0;this.sp=61440;this.cycles=0;this.ram=[];
};k.prototype.af=function(){return this.a<<8|this.f;};k.prototype.AF=function(u){this.a=u>>8&255;this.f=u&255;};k.prototype.bc=function(){return((this.b&255)<<8)|(this.c&255);
...
};k.prototype.step=function(){var v=h(this.pc++);var u=this.cycles;this.execute(v);this.pc&=65535;return this.cycles-u;};k.prototype.writePort=function(w,u){if(b){b(w&255,u);
}};k.prototype.readPort=function(u){if(o){return o(u&255);}return 255;};k.prototype.getByte=function(u){return h(u&65535);};k.prototype.getWord=function(w){var u=h(w&65535);
var v=h((w+1)&65535);return v<<8|u;};k.prototype.nextByte=function(){var v=this.pc;var u=h(v&65535);this.pc=(v+1)&65535;return u;};k.prototype.nextWord=function(){var v=this.pc;
var u=h(v&65535);var w=h((v+1)&65535);this.pc=(v+2)&65535;return w<<8|u;};k.prototype.writeByte=function(x,w){var u=w&255;t(x&65535,u);};k.prototype.writeWord=function(x,w){var u=w;
var v=w>>8;this.writeByte(x&65535,u);this.writeByte((x+1)&65535,v);};k.prototype.calcFlags=function(y,w,z){var u=y&255;if(y>=256||y<0){this.f|=e;}else{this.f&=~e&255;
}this.f=f[u];if(y>=256||y<0){this.f|=e;}else{this.f&=~e&255;}return u;};k.prototype.acADD=function(w,v,z){var u=[0,s,s,s,0,0,0,s];var x=(z&8)>>1|(v&8)>>2|(w&8)>>3;
var y=u[x];this.f=this.f&~s|y;};k.prototype.acSUB=function(w,v,z){var u=[s,s,0,s,0,s,0,0];var x=(z&8)>>1|(v&8)>>2|(w&8)>>3;var y=u[x];this.f=this.f&~s|y;
};k.prototype.incrementByte=function(v){var w=this.f&e;var u=this.calcFlags(v+1,v,1);this.f=(this.f&~e&255)|w;if((u&15)===0){this.f=this.f|s;}else{this.f&=~s&255;
}return u;};k.prototype.decrementByte=function(v){var w=this.f&e;var u=this.calcFlags(v-1,v,1);this.f=(this.f&~e&255)|w;if((v&15)>0){this.f=this.f|s;}else{this.f&=~s&255;
}return u;};k.prototype.addByte=function(u,w){var v=this.calcFlags(u+w,u,w);this.acADD(u,w,v);return v;};k.prototype.addByteWithCarry=function(u,w){var v=this.addByte(u,w+((this.f&e)?1:0));
this.acADD(u,w,v);return v;};k.prototype.subtractByte=function(u,w){var v=this.calcFlags(u-w,u,w);this.acSUB(u,w,v);return v;};k.prototype.subtractByteWithCarry=function(u,x){var w=x+((this.f&e)?1:0);
var v=this.calcFlags(u-w,u,w);this.acSUB(u,x,v);return v;};k.prototype.andByte=function(v,y){var u=this.calcFlags(v&y,v,y);var w=(v&8)|(y&8);if(w>0){this.f|=s;
}else{this.f&=~s;}this.f&=~e&255;return u;};k.prototype.xorByte=function(v,w){var u=this.calcFlags(v^w,v,w);this.f&=~s;this.f&=~e&255;return u;};k.prototype.orByte=function(v,w){var u=this.calcFlags(v|w,v,w);
this.f&=~s;this.f&=~e&255;return u;};k.prototype.addWord=function(u,w){var v=u+w;if(v>65535){this.f|=e;}else{this.f&=~e;}return v&65535;};k.prototype.pop=function(){var u=this.getWord(this.sp);
this.sp=(this.sp+2)&65535;return u;};k.prototype.push=function(u){this.sp=(this.sp-2)&65535;this.writeWord(this.sp,u);};k.prototype.processInterrupts=function(){};
k.prototype.execute=function(y){var A,D,B;this.f&=215;this.f|=2;switch(y){case 0:case 8:case 16:case 24:case 32:case 40:case 48:case 56:this.cycles+=4;
...
break;case 119:this.writeByte(this.hl(),this.a);this.cycles+=7;break;case 120:this.a=this.b;this.cycles+=5;break;case 121:this.a=this.c;this.cycles+=5;
...
this.cycles+=10;break;case 202:if(this.f&m){this.pc=this.nextWord();}else{this.pc=(this.pc+2)&65535;}this.cycles+=10;break;case 204:if(this.f&m){this.cycles+=18;
...
break;case 210:if(this.f&e){this.cycles+=10;this.pc=(this.pc+2)&65535;}else{this.cycles+=15;this.pc=this.nextWord();}break;case 211:this.writePort(this.nextByte(),this.a);
this.cycles+=10;break;case 212:if(this.f&e){this.cycles+=11;this.pc=(this.pc+2)&65535;}else{this.cycles+=18;D=this.nextWord();this.push(this.pc);this.pc=D;
...
this.pc=16;this.cycles+=11;break;case 216:if(this.f&e){this.pc=this.pop();this.cycles+=11;}else{this.cycles+=5;}break;case 218:if(this.f&e){this.cycles+=15;
this.pc=this.nextWord();}else{this.cycles+=10;this.pc=(this.pc+2)&65535;}break;case 219:this.a=this.readPort(this.nextByte());this.cycles+=10;break;case 220:if(this.f&e){this.cycles+=18;
...
}break;case 225:this.HL(this.pop());this.cycles+=10;break;case 226:if(this.f&a){this.cycles+=10;this.pc=(this.pc+2)&65535;}else{this.cycles+=15;this.pc=this.nextWord();
...
}else{this.cycles+=18;D=this.nextWord();this.push(this.pc);this.pc=D;}break;case 229:this.push(this.hl());this.cycles+=11;break;case 230:this.a=this.andByte(this.a,this.nextByte());
...
}break;case 233:this.pc=this.hl();this.cycles+=4;break;case 234:if(this.f&a){this.cycles+=15;this.pc=this.nextWord();}else{this.cycles+=10;this.pc=(this.pc+2)&65535;
}break;case 235:D=this.de();this.DE(this.hl());this.HL(D);this.cycles+=4;break;case 236:if(this.f&a){this.cycles+=18;D=this.nextWord();this.push(this.pc);
this.pc=D;}else{this.cycles+=11;this.pc=(this.pc+2)&65535;}break;case 238:this.a=this.xorByte(this.a,this.nextByte());this.cycles+=7;break;case 239:this.push(this.pc);
...
break;case 242:if(this.f&d){this.cycles+=10;this.pc=(this.pc+2)&65535;}else{this.cycles+=15;this.pc=this.nextWord();}break;case 243:this.f&=~j&255;this.cycles+=4;
break;case 244:if(this.f&d){this.cycles+=11;this.pc=(this.pc+2)&65535;}else{this.cycles+=18;D=this.nextWord();this.push(this.pc);this.pc=D;}break;case 245:this.push(this.af());
this.cycles+=11;break;case 246:this.a=this.orByte(this.a,this.nextByte());this.cycles+=7;break;case 247:this.push(this.pc);this.pc=48;this.cycles+=11;break;
case 248:if(this.f&d){this.pc=this.pop();this.cycles+=11;}else{this.cycles+=5;}break;case 249:this.sp=this.hl();this.cycles+=6;break;case 250:if(this.f&d){this.cycles+=15;
this.pc=this.nextWord();}else{this.cycles+=10;this.pc=(this.pc+2)&65535;}break;case 251:this.f|=j;this.cycles+=4;break;case 252:if(this.f&d){this.cycles+=17;
D=this.nextWord();this.push(this.pc);this.pc=D;}else{this.cycles+=11;this.pc=(this.pc+2)&65535;}break;case 254:this.subtractByte(this.a,this.nextByte());
this.cycles+=7;break;case 255:this.push(this.pc);this.pc=56;this.cycles+=11;break;default:this.cycles+=4;break;}this.f&=215;this.f|=2;};var g,l=false;var p=function(){g.pc=0;
g.sp=0;g.a=g.b=g.c=g.d=g.e=g.h=g.l=0;g.f=2;g.cycles=0;};var i=function(u){console.log(toHex4(u.pc));};r.trace=function(u){l=u;};r.steps=function(u){T=0;
while(u>0){u-=g.step();if(l){i(g);}}};r.T=function(){return g.cycles;};r.reset=p;r.init=function(v,y,u,w,x){t=v;h=y;q=u;b=w;o=x;g=new k();p();};r.status=function(){return{pc:g.pc,sp:g.sp,a:g.a,b:g.b,c:g.c,d:g.d,e:g.e,f:g.f,h:g.h,l:g.l};
};r.interrupt=function(u){if(g.f&j){g.push(g.pc);g.pc=u||56;}};r.set=function(u,v){u=u.toUpperCase();switch(u){case"PC":g.pc=v;return;case"A":g.a=v;return;
case"B":g.b=v;return;case"C":g.c=v;return;case"D":g.d=v;return;case"E":g.e=v;return;case"H":g.h=v;return;case"L":g.l=v;return;case"F":g.f=v;return;case"SP":g.sp=v;
return;}};r.flagsToString=function(){var w="",v="SZ0A0P1C";for(var u=0;u<8;u++){var x=g.f&(128>>u);if(x===0){w+=v[u].toLowerCase();}else{w+=v[u];}}return w;
